...
if os.path.isfile("mnist.dat"):
    mnistFilename = "mnist.dat"
elif os.path.isfile('examples\cudamat\mnist.dat'):
    mnistFilename = 'examples\cudamat\mnist.dat'
else:   
    raise ValueError( "mnist.dat file not found. Aborting" )   
