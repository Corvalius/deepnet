...
if os.path.isfile("mnist49.dat"):
    mnistFilename = "mnist49.dat"
elif os.path.isfile('examples\cudamat\mnist49.dat'):
    mnistFilename = 'examples\cudamat\mnist49.dat'
else:   
    raise ValueError( "minst49.dat file not found. Aborting" )   

# initialize CUDA
cm.cublas_init() 

# load data
util.load(mnistFilename, globals())
